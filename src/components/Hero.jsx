  ...
  return (
    <div className="relative w-full h-[70vh] sm:h-[70vh] lg:h-screen">
      ...
      >
        ...
        {/* Text overlay */}
        <div className="absolute inset-0 flex flex-col justify-center items-center px-2 xs:px-4 sm:px-6 md:px-8 lg:px-12 text-center lg:items-start lg:text-left lg:justify-start">
          <div className="w-full max-w-xs xs:max-w-sm sm:max-w-3xl mx-auto lg:mx-0 lg:ml-12 xl:ml-16 lg:pt-32">
            ...
            <div className="mt-8 xs:mt-10 sm:mt-12 flex flex-col gap-4 sm:flex-row sm:gap-4">
              <a 
                href="#projects" 
